...
// Trade-Manager
const string STR_INFO_TRADE_ACCEPT = "P?ijmout";
const string STR_INFO_TRADE_RESET  = "Odmítnout";
const string STR_INFO_TRADE_EXIT   = "Zp?t";
const string STR_INFO_TRADE_VALUE  = "Hodnota:";

const string _STR_MESSAGE_TRADE_FAILURE_PLAYER  = "Nemáš dostatek zlata.";
const string _STR_MESSAGE_TRADE_FAILURE_NPC     = "Obchodník nemá dostatek zlata.";
const string _STR_MESSAGE_TRADE_BALANCE         = "Hodnota nabídky vyrovnána.";
